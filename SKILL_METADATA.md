...
| Skill | Description |
| --- | --- |
| `/jevify` | Run /jevify to audit runtime AI calls in a Lovable project, distinguish generation from structured decisions, and propose System One candidates. Returns a report in chat without changing code. Targets runtime AI cost, not build credits. |
